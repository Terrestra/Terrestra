...
$$.Chat = {"":"Object;chatInputField>,chatOutputField",
 Chat$1: function(ws) {
  var t1;
  this.chatInputField = $.query("#chatInput");
  this.chatOutputField = $.query("#chatOutput");
  t1 = this.chatInputField.get$on().get$input();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.anon(this, ws));
  t1 = this.chatInputField.get$value();
  if (t1 == null)
    ws.send$1(" ");
  else
    ws.send$1(t1);
...
$$.main_anon = {"":"Closure;ws_0",
 call$1: function(a) {
  this.ws_0.send$1("Welcome to the Chat!");
}
};
...
$$.main_anon0 = {"":"Closure;",
 call$1: function(a) {
  $.print("F7U12");
  $.print($.getInterceptor(a).toString$0(a));
}
};
...
$$.main_anon2 = {"":"Closure;",
 call$1: function(message) {
  var messageData, t1;
  messageData = $.JSON_parse(message.get$data());
  t1 = $.getInterceptor$JSStringJSArray(messageData);
  $.print(t1.operator$index$1(messageData, "message"));
  t1 = t1.operator$index$1(messageData, "message");
...
$$.anon = {"":"Closure;this_0,ws_1",
 call$1: function(a) {
  var t1, t2;
  t1 = this.this_0.get$chatInputField();
  t2 = t1.get$value();
  if (t2 == null)
    t1.set$text("ehhh");
  else
    this.ws_1.send$1($.JSON_stringify($.makeLiteralMap(["messageType", 3, "chat", t2])));
}
};
...
$.main = function() {
  var ws, t1;
  ws = $.WebSocket_WebSocket("ws://192.168.2.103:8080/ws");
  $.Chat$(ws);
  $.query("#clientInput");
  t1 = ws.get$on().get$open();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon(ws));
  t1 = ws.get$on().get$error();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon0());
  t1 = ws.get$on().get$close();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon1());
  t1 = ws.get$on().get$message();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon2());
};
...
$.$defineNativeClass('WebSocket', {
 ...
 get$close: function() {
  return new $.BoundClosure(this, 'close$2');
},
...
(function() {
  ...
  $.dynamicSetMetadata([['HTMLMediaElement', v0_MediaElement], ['Element', v1_Element], ['Uint8Array', 'Uint8Array|Uint8ClampedArray'], ['Document', v2_Document], ['DocumentFragment', v3_DocumentFragment], ['CharacterData', v4_CharacterData], ['Node', v5_Node], ['EventTarget', [v5_Node, 'EventTarget|WebSocket'].join('|')]]);
})();
...
//@ sourceMappingURL=terrestraClient.dart.js.map